...
import io.everyonecodes.w1springbeans.drhousediagnoses.communication.endpoints.PatientEndpointW4;
...
public class PatientEndpointW4Test {

    @Autowired
    PatientEndpointW4 patientEndpointW4;
    ...
    @Test
    void test(){
        when(patientEndpointW4.postPatient(patient)).thenReturn(expectedPatient);

        Patient actual = patientEndpointW4.postPatient(patient);
